...
const serverUrl = 'localhost:4200';
...
export class ItemService {
    ...
    getPagined(page: number, limit: number): Observable<Item[]> {
        console.log(page);
        console.log(limit);
        return this.http.get<Item[]>(`${itemUrl}?page=${page}&limita=${limit}`, this.authHttpOptions());
    }
}
